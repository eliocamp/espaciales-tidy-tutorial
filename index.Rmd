...
Esta es la agenda tentativa del tutorial comenzando a las 15:15 UTC-3 (podés revisar el horario en tu país en el [programa de tutoriales](https://user2021.r-project.org/program/tutorials/)). Haremos todo lo posible por respetar el horario de las pausas para que puedar organizarte mejor. 

|Minutos </br> desde el comienzo |Contenidos|
|:---|----------|
|10  |Introducción |
|40  |Tema 1 |
